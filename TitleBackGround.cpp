...
TitleBackGround* TitleBackGround::pInst = nullptr;
...
TitleBackGround* TitleBackGround::getInstance()
{
	if (nullptr == pInst)
		pInst = new TitleBackGround;
...
void TitleBackGround::readObj(const char* fileName)
{
