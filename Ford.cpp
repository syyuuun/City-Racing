...
Ford::Ford()
{
	readObj("Resources/Car/FORD/crown_victoria.obj");
}

void Ford::initialize()
{
...
void Ford::readObj(const char* objName)
{
...
void Ford::inputKeyboard(unsigned char key, int x, int y)
{

}

void Ford::inputSpecialKeyboard(int key, int x, int y)
{

}

void Ford::inputMouse(int button, int state, int x, int y)
{
